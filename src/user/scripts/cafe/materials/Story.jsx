      ...
      <div className="mission-container">Наша історія</div>
        ...
        <div className="mission-article-container">
          <div className="left-section-container">
            ...
            Наш заклад – це ідеальне поєднання кафе, де можна насолодитися    ароматним кавою і свіжозавареними еспресо, і пивного бару з   величезним   вибором місцевих та імпортних сортів пива. 
          </div>

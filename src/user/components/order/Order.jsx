    ...
    <>
      ...
      <main className={`${styles.main} text-black`}>
        ...
        <div className={`${styles.enterPhoneContainer} flex flex-col  mb-[40px]`}>
          <label htmlFor="phone" className={`pretitleText`}>Номер телефону:</label>
          ...
          <button onClick={() => props.handleLoggining(phoneNumber)} className={`btn`}>
            Отримати код
          </button>
        </div>
        <div className={`${styles.enterPhoneContainer} flex flex-col`}>
          <label htmlFor="phone" className={`pretitleText`}>Код з СМС:</label>
          <input
            type="tel"
            id="phone"
            name="phone"

...
function News() {
  return (
    ...
    <div className={`${styles.headerSection} relative w-full flex flex-col max-h-[140px]`}>
    ...
    <img className={`my-[10px] w-full object-fit`}  src="/images/background/fries.svg"/>
...
function CreateNewsItem(props) {
  ...
  return (
    ...
    {isMobile ? 
      <div id={`#${props.id}`}  className={`${styles.itemContainer} w-full flex flex-col`}>
      ...
      <div id={`#${props.id}`} className={`${styles.itemContainer} w-full flex flex-row`}>

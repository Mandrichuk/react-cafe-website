      ...
      {totalPrice.length === 0 ? (
        ...
        <main className={`w-full`}>
          <div className={`${styles.mainContainer} text-black`}>
            <div
              className={` ${styles.allMeals} w-[100%] flex flex-col items-center justify-center mt-[50px] max-w-[800px] min-w-[450px]`}
            >
              {adminCart.map((item) => (
                <Meal id={item.id} amount={item.amount} />
              ))}
            </div>

            <div
              className={`${styles.orderContainer} flex flex-col text-[1.4rem] mt-[100px] mb-[100px]`}
            >
              <label
                htmlFor="orderComment"
                className={`${styles} text-[1.2rem]`}
              >
              ...
              />
              <div
                className={`${styles.totalCost} border-b-[1px] border-black black p-[10px] mb-[80px]`}
              >

...
function Header() {
  ...
  return (
    <div className={`${styles.header} px-[20px] fixed top-[0] flex flex-row items-center h-[70px] w-[100%] bg-black justify-between text-white text-[1.3rem]`}>
      <img className=" hidden max-w-[130px] object-cover sm:block" src="/images/icons/drink-food-logo.png" />
